...
/**  InstanceInfo 应用实例信息  Eureka-Client 向 Eureka-Server 注册该对象信息 注册成功后 可以被其他 Eureka-Client 发现  */
...
public class InstanceInfo {
    ...
    // The (fixed【固定】) instanceId for this instanceInfo. This should be unique within the scope of the appName.
