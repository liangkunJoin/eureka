...
public class EurekaConfigBasedInstanceInfoProvider implements Provider<InstanceInfo> {
    ...
    public synchronized InstanceInfo get() {
        if (instanceInfo == null) {
            ...
            // set the appropriate(合适) id for the InstanceInfo, falling back to datacenter Id if applicable, else hostname
            /** 应用实例编号  */
            ...
            /** 应用初始化后 是否开启  应用不开启，应用实例处于 STARTING 状态 ； 应用开启，应用实例处于 UP 状态 */
