...
public class ApplicationResource {
     ...
     */
    @GET
    public Response getApplication(@PathParam("version") String version, @HeaderParam("Accept") final String acceptHeader,
    ...
    public Response addInstance(InstanceInfo info, @HeaderParam(PeerEurekaNode.HEADER_REPLICATION) String isReplication) {
        ...
        // 注册应用实例信息,请求头 isReplication 参数，和 Eureka-Server 集群复制相关
