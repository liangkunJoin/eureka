...
public interface EurekaServerConfig {
     ...
     *
     * todo 自我保护机制相关  开启自我保护模式比例，超过该比例后开启自我保护模式。
     */
     ...
     *
     * todo 自我保护机制相关 自我保护模式比例更新频率，单位：毫秒。
     */
     ...
     * <em>The changes are effective at runtime.</em>
     * </p>
     * TODO Eureka-Server 集群同步相关
     * TODO Eureka-Server 集群节点更新频率，单位：毫秒。
     * TODO（后面源码在细读，可能要修正）
     ...
     *
     * TODO Eureka-Server 集群同步相关
     *  TODO Eureka-Server 启动时，从远程 Eureka-Server 读取不到注册信息时，多长时间不允许 Eureka-Client 访问。
     *   TODO（后面源码在细读，可能要修正）
     */
     ...
     * @return time in milliseconds
     *
     * todo 获取注册信息请求相关  租约变更记录过期时长，单位：毫秒  默认值 ： 360 * 1000 毫秒。
     */
     ...
     * @return time in milliseconds.
     *
     * todo 获取注册信息请求相关  移除队列里过期的租约变更记录的定时任务执行频率，单位：毫秒。默认值 ：30 * 1000 毫秒。
     */
     ...
     * wake up and run.
     *
     * todo 注册的应用实例的租约过期相关 租约过期定时任务执行频率，单位：毫秒。
     *
     * @return time in milliseconds.
     */
     ...
     *
     * todo 获取注册信息请求相关  写缓存写入后过期时间，单位：秒。
     *
     ...
     * be updated.
     *
     * todo 获取注册信息请求相关  只读缓存更新频率，单位：毫秒。
     *
     ...
     *
     * todo Eureka-Server 集群同步相关
     * todo 是否同步应用实例信息，当应用实例信息最后更新时间戳( lastDirtyTimestamp )发生改变。
     *
     ...
     *
     * todo  Eureka-Server 远程节点( 非集群 )读取相关
     * TODO  Eureka-Server 启动时，从远程 Eureka-Server 读取失败重试次数。
     *
     * @return the number of retries
     */
     ...
     *
     *  todo  Eureka-Server 远程节点( 非集群 )读取相关
     *  todo Eureka-Server 启动时，从远程 Eureka-Server 读取失败等待( sleep )间隔，单位：毫秒。
     *
     ...
     * regions.
     *
     * TODO  【读取】远程 Eureka-Server 请求连接超时时间，单位：毫秒
     * @return timeout value in milliseconds.
     */
     ...
     * remote regions.
     *
     * TODO 【读取】远程 Eureka-Server 请求读取超时时间，单位：毫秒
     * @return timeout value in milliseconds.
     */
     ...
     *
     * TODO  【读取】所有远程 Eureka-Server 请求总连接数
     * @return total number of allowed <em>HTTP</em> connections.
     */
     ...
     *
     * TODO  【读取】单个远程 Eureka-Server 请求总连接数
     *
     * @return total number of allowed <em>HTTP</em> connections for a peer
     *         node.
     */
     ...
     *
     * TODO  【读取】远程 Eureka-Server 请求空闲超时时间，单位：毫秒
     *
     * @return idle time in seconds.
     */
     ...
     * network traffic.
     *
     *  TODO  是否 GZIP 解压 从远程 Eureka-Server 的内容
     *
     ...
     *  TODO Eureka-Server 远程节点( 非集群 )读取相关
     *
     *  TODO 远程 Eureka-Server 映射
     *  TODO key：Eureka-Server 名
     *  TODO value：Eureka-Server 地址
     *
     ...
     *
     *      TODO Eureka-Server 远程节点( 非集群 )读取相关
     *      TODO 从远程 Eureka-Server 拉取应用注册信息集合。
     *      TODO（后面源码在细读，可能要修正）
     *
     */
    @Nullable
    ...
    /**
     *  TODO Eureka-Server 远程节点( 非集群 )读取相关
     *  TODO 远程 Eureka-Server 拉取注册信息的间隔，单位：秒
     *
    ...
    /**
     *  TODO Eureka-Server 远程节点( 非集群 )读取相关
     *  TODO 远程 Eureka-Server 拉取注册信息的线程池大小
     *
    ...
    /**
     * TODO 远程 Eureka-Server 信任存储文件的密码
     *
     ...
     *
     * TODO Eureka-Server 远程节点( 非集群 )读取相关
     * TODO 是否禁用本地读取不到注册信息，从远程 Eureka-Server 读取。
     *
    ...
    /**
     *  TODO  请求认证相关 打印访问的客户端名和版本号，配合 Netflix Servo 实现监控信息采集。
     *
     ...
     *
     * TODO 请求限流相关 是否限制非标准客户端的访问。
     *
     * TODO 标准客户端通过请求头( header )的 "DiscoveryIdentity-Name" 来判断，是否在标准客户端名集合里。
     *
     */
     ...
     *
     *  TODO  请求限流相关 标准客户端名集合
     *
     *  TODO 标准客户端名集合。默认包含"DefaultClient" 和 "DefaultServer" 。
     *
     */
     ...
     *
     * TODO 请求限流相关 速率限制的 burst size ，使用令牌桶算法。
     *
     */
